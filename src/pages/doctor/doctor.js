...
const Doctor = ({location}) => {
    const {name, title, image} = location.state.details
   const scroll = (e) => {
        e.preventDefault()    
    ...
    return (
        <div>
            <Header />
            <header class="dl-profile-header">
                <div class="dl-profile-overlay">
                    <div class="dl-profile-wrapper">
                        ...
                        <div class="dl-profile-header-name-speciality">
                            <h1 class="dl-profile-header-name">{name}</h1>
                            <h2 class="dl-profile-header-speciality">{title}</h2>
                        </div>
                    </div>
                </div>
            </header>
